...
SELECT 
 ...
 COUNT(*) AS file_count, -- (1) File count
 ROUND(
...
WHERE 
 ...
 AND f.filesize > 0 -- (2) Exclude zero-byte files
GROUP BY 
 c.fullname, 
 a.id,
 a.name,
 cm.id -- (3) Group by all non-aggregated cols
ORDER BY 
